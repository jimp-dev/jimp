...
export default function pluginColor() {
    return {
        class: {
            /**
            ...
            contrast(val, cb) {
                ...
                this.scanQuiet(
                    ...
                    function(x, y, idx) {
                        ...
                        this.bitmap.data[idx + 1] = adjust(
                            this.bitmap.data[idx + 1]
                        );
                        this.bitmap.data[idx + 2] = adjust(
                            this.bitmap.data[idx + 2]
                        );
                    }
                );
            ...
            posterize(n, cb) {
                ...
                this.scanQuiet(
                    ...
                    function(x, y, idx) {
                        this.bitmap.data[idx] =
                            (Math.floor(
                                (this.bitmap.data[idx] / 255) * (n - 1)
                            ) /
                                (n - 1)) *
                            255;
                        this.bitmap.data[idx + 1] =
                            (Math.floor(
                                (this.bitmap.data[idx + 1] / 255) * (n - 1)
                            ) /
                                (n - 1)) *
                            255;
                        this.bitmap.data[idx + 2] =
                            (Math.floor(
                                (this.bitmap.data[idx + 2] / 255) * (n - 1)
                            ) /
                                (n - 1)) *
                            255;
                    }
