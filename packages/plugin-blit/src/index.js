...
export default function pluginBlit() {
    return {
        class: {
            /**
            ...
            blit(src, x, y, srcx, srcy, srcw, srch, cb) {
                ...
                src.scanQuiet(srcx, srcy, srcw, srch, function(sx, sy, idx) {
                    if (
                        ...
                        baseImage.bitmap.data[dstIdx + 1] = this.bitmap.data[
                            idx + 1
                        ];
                        baseImage.bitmap.data[dstIdx + 2] = this.bitmap.data[
                            idx + 2
                        ];
                        baseImage.bitmap.data[dstIdx + 3] = this.bitmap.data[
                            idx + 3
                        ];
                    }
                });
