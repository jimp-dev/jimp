const should = require('should'); // Ensure should to load in browser through browserify.

// eslint-disable-next-line no-use-extend-native/no-use-extend-native
const shouldAssertion = {}.should.be.constructor.prototype;

exports.hasOwnProp = (obj, key) =>
  Object.prototype.hasOwnProperty.call(obj, key);

const hashForEach = (hash, func) => {
  for (const key in hash)
    if (exports.hasOwnProp(hash, key)) func(key, hash[key]);
};
...
const jgdReadableMatrix = function(img) {
  const rMatrix = [];
  let line = [];
...
exports.donutJGD = function(_, i, X) {
