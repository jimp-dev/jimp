...
<Aside type="caution" title="Watch out!">
  Jimp is built on JavaScript implementations of image formats. These implementations are not optimized for performance and may allocate a lot of memory before using.
</Aside>
