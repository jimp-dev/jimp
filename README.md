...
image.resizeMode(mode);        // sets the resize interpolation mode, defaults to Jimp.RESIZE_NEAREST_NEIGHBOR, available: Jimp.RESIZE_NEAREST_NEIGHBOR, Jimp.RESIZE_BILINEAR, Jimp.RESIZE_BICUBIC, Jimp.RESIZE_HERMITE, Jimp.RESIZE_BEZIER
