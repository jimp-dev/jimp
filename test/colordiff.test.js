...
describe("compute color difference", ()=> {
    ...
    it("totally transparent", ()=> {
        Jimp.colorDiff(
            {r: 255, g: 0, b: 0, a: 0}, {r: 255, g: 0, b: 0, a: 0}
        ).should.be.equal(0, "both transparent red");

        Jimp.colorDiff(
            {r: 0, g: 0, b: 0, a: 0}, {r: 255, g: 255, b: 255, a: 0}
        ).should.be.equal(1, "transparent black x transparent white");
    });

    it("different alpha", ()=> {
        pct(Jimp.colorDiff(
            {r: 255, g: 0, b: 0, a: 100}, {r: 255, g: 0, b: 0, a: 150}
        )).should.be.equal(3.8, "both red");

        Jimp.colorDiff(
            {r: 0, g: 0, b: 0, a: 0}, {r: 255, g: 255, b: 255, a: 255}
        ).should.be.equal(1, "transparent black x transparent white");
    });
